...
def calling():
    ...
    def detect_color(c1,c2,img):
        ...
        y2=int(c2[1])
        a=img[y1:y2,x1:x2]
        color_mean=np.mean(a)##can we use other techniques? try your self rushil
...
##        cv2.imshow("red",r)
        ...
        print(" The {0} is {1}% Red {2}%Green {3}%Blue".format(label,l[2],l[1],l[0]))
    ...
    images_source_path= glob.glob(r'C:\Users\Kumarpal\Desktop\kavish code\images\*')
